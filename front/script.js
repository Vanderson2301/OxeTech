...
menuBtn.addEventListener("click", () => {
 ...
 function exibirProjetos(lista) {
    ...
    lista.forEach(projeto => {
        projetosContainer.innerHTML += `
            <div class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-lg mt-4 mx-10 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
